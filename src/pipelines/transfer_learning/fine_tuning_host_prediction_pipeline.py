...
def execute(config):
    ...
    for iter in range(n_iters):
        ...
        # TODO: REVERT THIS HACK OF LOADING A CHECKPOINT
        pre_trained_encoder_model = nn_utils.load_checkpoint(pre_trained_encoder_model, pre_train_settings["model_path"])
