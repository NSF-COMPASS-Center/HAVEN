...
| Virus Host Prediction - test only - HAVEN            | virus_host_prediction_test | [cov-s-host-prediction-multi-uniref90-sarscov2-variants.yaml](input/config-files/analysis/cov_spike_proteins/cov-s-host-prediction-multi-uniref90-sarscov2-variants.yaml)                              |
